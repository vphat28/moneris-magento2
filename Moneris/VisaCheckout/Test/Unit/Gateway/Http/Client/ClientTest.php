 ...
 */
namespace Moneris\VisaCheckout\Block\Test\Unit\Gateway\Http\Client;
...
class ClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->unit = $helper->getObject(
            \Moneris\VisaCheckout\Gateway\Http\Client\Client::class,
            [
    ...
    public function testPlaceRequest()
    {
        ...
        $this->assertTrue($this->unit->placeRequest($this->transferMock)['response'] instanceof \mpgResponse);
    }
}