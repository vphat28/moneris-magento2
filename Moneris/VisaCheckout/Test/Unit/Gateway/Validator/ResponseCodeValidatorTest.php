 ...
 */
namespace Moneris\VisaCheckout\Block\Test\Unit\Gateway\Validator;
...
class ResponseCodeValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->unit = $helper->getObject(
            \Moneris\VisaCheckout\Gateway\Validator\ResponseCodeValidator::class,
            [
    ...
    public function testValidate()
    {
        ...
        $this->quoteMock
            ...
            ->will($this->returnValue($this->quoteMock));
        $this->assertEquals(null, $this->unit->validate(['response' => ['response' => $response]]));
    }
}