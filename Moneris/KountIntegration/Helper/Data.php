...
class Data
{
    ...
    public function getMonerisStoreID($store = null)
    {
        return $this->scopeConfig->getValue('payment/chmoneriskount/moneris_store_id', ScopeInterface::SCOPE_STORE, $store);
    }

    public function getMonerisAPIToken($store = null)
    {
        return $this->scopeConfig->getValue('payment/chmoneriskount/moneris_api_token', ScopeInterface::SCOPE_STORE, $store);
    }
